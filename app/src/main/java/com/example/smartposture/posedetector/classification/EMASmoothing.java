...
public class EMASmoothing {
  ...
  public void cleanup() {
    // Add resource cleanup logic if any resources are managed in the future
    // For now, this method is a placeholder for consistency and future-proofing.
    // No resources to clean up in the current implementation.
    System.out.println("EMASmoothing resources cleaned up.");
  }
}
